...
namespace SmartReader.Data.Migrations
{
    ...
    [Migration("20240311165603_AddHistoryStatus")]
    partial class AddHistoryStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartReader.Core.Domain.ExtractHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartReader.Core.Domain.ExtractHistory", b =>
                {
                    b.HasOne("SmartReader.Core.Domain.Extract", null)
                        .WithMany("Histories")
